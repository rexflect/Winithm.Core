...
public partial class NoteFloat : Control, IPoolable
{
  ...
  public void SetNoteType(NoteType type, bool highlighting, ResourcePack resourcePack)
  {
    ...
    _base?.Texture = GetTextureSafe(Type, highlighting ? NotePart.BaseHL : NotePart.Base);
    ...
    _indicator?.Texture = GetTextureSafe(NoteType.Indicator, highlighting ? NotePart.BaseHL : NotePart.Base);
  ...
  public void UpdateVisual()
  {
    ...
    if (_overlay?.Texture is not null)
    {
